...
# List of metrics for pivot tables
metrics = ['Lifetime', 'Total Energy', 'Total Size', 'Number of Dead Nodes', 
           'Average Loss', 'Average Delay', 'Total Process Energy', 'Average Process Time']
