...
def is_float(string):
    if string.replace(".", "").isnumeric():
        ...
        return False
def Extract_Results(log_filename,OutputFile,trfile,strlabel,total_nodes):
    total_recv=0
    total_delay=0
    total_txenergy=0
    total_rxenergy=0
    ...
    with open(log_filename, "r") as f:
        for line in f:
            ...
            if fields[1] == "R":
                ...
                if float(fields[12])>0 and float(fields[8])==0: #no loss
                    count_size+=1
    ...
    if count>0:
        with open(OutputFile, "a") as f:
            ...
            f.write("\nTotal Energy:"+str(total_rxenergy+total_txenergy+total_processenergy))
